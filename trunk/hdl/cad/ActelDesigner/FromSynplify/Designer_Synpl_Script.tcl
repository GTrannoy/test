...
import_source -merge_timing "yes" -format "EDIF" -edif_flavor "GENERIC" {C:\ohr\cern-fip\trunk\hdl\cad\Synplify\nanofip.edn} -format "SDC" {C:\ohr\cern-fip\trunk\hdl\cad\Actel_designer\FromSynplify\Designer_Synpl_TimeConstr.sdc}
...
import_aux -format "PDC" {C:\ohr\cern-fip\trunk\hdl\cad\libero\NanoFip\constraint\Designer_Synpl_Pinout.pdc}
