...
set_input_dir C:/ohr/cern-fip/trunk/hdl/cad/precision_radtol

set_results_dir C:/ohr/cern-fip/trunk/hdl/cad/precision_radtol/nanofip_impl_1/
...
# Constraints file
# ##################
add_input_file {./constraints/nanofip_precision_radtol.sdc}

# ###################
# Chip
# ##################
setup_design -manufacturer Actel -family ProASIC3 -part A3P400 -speed -2 -package "208 PQFP"
...
setup_design -max_fanout=24 -max_fanout_strategy=AUTO
setup_design -frequency 40
# setup_design -input_delay 10 -output_delay 10 

# ###################
# TMR
# ##################
setup_design -encoding=onehot -advanced_fsm_optimization=false  -reencode_fsm_outputs=false
setup_design -safe_fsm_type=basic -radhardmethod=ltmr
